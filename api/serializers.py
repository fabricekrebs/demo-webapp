...
class TaskSerializer(serializers.ModelSerializer):
    ...
    project_id = serializers.PrimaryKeyRelatedField(queryset=Project.objects.all(), source='project', write_only=True, allow_null=True, required=False)

    class Meta:
        model = Task
        fields = ['id', 'title', 'description', 'owner', 'owner_detail', 'project', 'project_id', 'creation_date', 'due_date', 'duration', 'priority']
